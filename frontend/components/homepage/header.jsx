      ...
      <header>
        <div className="header">
          ...
          <div className="single-line-menus">
            <div className="item-phone menu-item">1-714-322-5115</div>
            <div id="top-menus" className="top-menus">
              <div className="redfin-menu">
                 <HeaderBuySell buy={true}/>
                 <HeaderBuySell buy={false}/>
                <div className="agents-responsive redfin-menu-item menu-item" onClick={this.clickLink('agents')}>Real Estate Agents</div>
              </div>
            </div>
            <div id="user-menus">
              <div id="sign-up" className="user-menu-item menu-item" onClick={this.clickLink('sign-up')}>
                Sign Up
              </div>
              <div id="login" className="user-menu-item menu-item" onClick={this.clickLink('login')}>
                Join
              </div>
            </div>
          </div>
